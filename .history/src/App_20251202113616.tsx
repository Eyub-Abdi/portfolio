            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <img 
                    src="/dp.jpeg" 
                    alt="Ayub Abdi - Cybersecurity Specialist" 
                    className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-panel-bg shadow-2xl relative z-10"
                  />
                  ...
                  {/* Glitch Effect Lines */}
                  <div className="absolute top-1/4 left-0 right-0 h-px bg-red-terminal/50 z-20 animate-pulse"></div>
                  <div className="absolute top-1/2 left-0 right-0 h-px bg-red-terminal/30 z-20 animate-pulse" style={{animationDelay: '0.5s'}}></div>
                  <div className="absolute top-3/4 left-0 right-0 h-px bg-red-terminal/50 z-20 animate-pulse" style={{animationDelay: '1s'}}></div>
