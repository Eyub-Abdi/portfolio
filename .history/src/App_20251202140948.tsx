        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-gray-text/90 mb-8">Intermediate Ethical Hacker, Security Enthusiast</h2>
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  {/* Profile Image Container with Effects */}
                  <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                    {/* Main Image */}
                    <img 
                      src="/dp.jpeg" 
                      alt="Ayub Abdi - Cybersecurity Specialist" 
                      className="w-full h-full rounded-full object-cover border-4 border-panel-bg shadow-2xl relative z-10 cursor-pointer transition-all duration-300 hover:scale-105 hover:border-red-terminal"
                      onMouseMove={(e) => {
                    ...
                    {/* Rocket Smoke Trail Effect - On Top */}
                    <div className="absolute inset-0 rounded-full overflow-hidden pointer-events-none z-30">
                      <div 
                        ...
                        style={{
                          ...
                          background: 'radial-gradient(circle, rgba(255, 26, 26, 0.6) 0%, rgba(255, 26, 26, 0.3) 30%, rgba(255, 26, 26, 0.1) 60%, transparent 100%)',
                          filter: 'blur(20px)',
                          animation: 'smoke-fade 1.5s ease-out infinite'
                        }}
                      ></div>
                      <div 
                        className="absolute w-32 h-32 rounded-full transition-all duration-300 ease-out"
                        style={{
                          left: `${mousePosition.x}%`,
                          top: `${mousePosition.y}%`,
                          transform: 'translate(-50%, -50%)',
                          background: 'radial-gradient(circle, rgba(255, 100, 100, 0.8) 0%, rgba(255, 26, 26, 0.4) 50%, transparent 100%)',
                          filter: 'blur(15px)'
                        }}
                      ></div>
                      <div 
                        className="absolute w-16 h-16 rounded-full transition-all duration-150 ease-out"
                        style={{
                          left: `${mousePosition.x}%`,
                          top: `${mousePosition.y}%`,
                          transform: 'translate(-50%, -50%)',
                          background: 'radial-gradient(circle, rgba(255, 150, 150, 1) 0%, rgba(255, 26, 26, 0.6) 70%, transparent 100%)',
                          filter: 'blur(8px)',
                          boxShadow: '0 0 30px rgba(255, 26, 26, 0.8)'
                        }}
                      ></div>
                    </div>
                    ...
                    {/* Corner Brackets */}
                    <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-red-terminal z-35 rounded-tl-full"></div>
                    <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-red-terminal z-35 rounded-tr-full"></div>
                    <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-red-terminal z-35 rounded-bl-full"></div>
                    <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-red-terminal z-35 rounded-br-full"></div>
