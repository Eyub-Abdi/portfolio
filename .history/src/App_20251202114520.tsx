          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-text/90 leading-relaxed">
                I'm an intermediate ethical hacker passionate about cybersecurity and penetration testing. 
                Currently expanding my knowledge through practical labs, CTF challenges, and online learning platforms 
                like TryHackMe and HackTheBox.
              </p>

              <p className="text-lg text-gray-text/90 leading-relaxed">
                My journey started with curiosity about how systems work and how they can be exploited. 
                Now I'm dedicated to building practical skills in vulnerability assessment, network security, 
