...
function App() {
  ...
  const skills = [
    { name: 'Penetration Testing', icon: 'fa-solid fa-unlock', description: 'Ethical hacking & vulnerability assessment' },
    { name: 'Network Security', icon: 'fa-solid fa-network-wired', description: 'Firewalls, IDS/IPS, VPN configuration' },
    { name: 'Linux & Kali', icon: 'fa-brands fa-linux', description: 'Advanced Linux systems & security tools' },
    { name: 'Python & Scripting', icon: 'fa-brands fa-python', description: 'Security automation & exploit development' },
    { name: 'Web Security', icon: 'fa-solid fa-shield-halved', description: 'OWASP Top 10, SQL injection, XSS' },
    { name: 'Malware Analysis', icon: 'fa-solid fa-virus', description: 'Reverse engineering & threat analysis' }
  ]
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              <div className="mb-6 overflow-hidden">
                <p className="text-red-terminal text-sm md:text-base font-semibold uppercase tracking-widest mb-4 animate-fade-in">Cybersecurity Specialist</p>
              </div>
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-text/90 mb-8">Ethical Hacker & Penetration Tester</h2>

              <p className="text-lg md:text-xl text-gray-text/80 mb-12 leading-relaxed">I secure digital infrastructures, hunt for vulnerabilities, and protect systems from cyber threats. Let's make the digital world safer together.</p>
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  {/* Glitch Effect Lines - Now with scan animation */}
                  <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-red-terminal to-transparent z-20 animate-scan-line"></div>
                  <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-terminal/70 to-transparent z-20 animate-scan-line-slow"></div>
                  <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-red-terminal/50 to-transparent z-20 animate-scan-line-fast"></div>
                  
                  {/* Additional scanning lines for depth */}
                  <div className="absolute top-0 left-0 right-0 h-px bg-red-terminal/40 z-20 animate-scan-line-reverse"></div>
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-red-terminal/80 via-red-terminal/80 to-transparent shadow-lg shadow-red-terminal/50 z-20 animate-scan-line-main"></div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-text/90 leading-relaxed">I'm a passionate cybersecurity professional specializing in penetration testing, vulnerability assessment, and ethical hacking. With a deep understanding of both offensive and defensive security, I help organizations protect their digital assets.</p>

              <p className="text-lg text-gray-text/90 leading-relaxed">My journey in cybersecurity started with a fascination for how systems work and how they can be secured. Today, I focus on identifying vulnerabilities before malicious actors can exploit them.</p>

              <div className="pt-4">
                <h3 className="text-xl font-semibold text-red-terminal mb-4">Quick Facts</h3>
                <ul className="space-y-2">
                  <li className="flex items-center gap-3">
                    <i className="fa-solid fa-graduation-cap text-red-terminal"></i>
                    <span>Certified Ethical Hacker (CEH)</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <i className="fa-solid fa-shield-halved text-red-terminal"></i>
                    <span>OSCP & Security+</span>
                  </li>
                  <li className="flex items-center gap-3">
                  ...
                  <li className="flex items-center gap-3">
                    <i className="fa-brands fa-linux text-red-terminal"></i>
      ...
      <section id="skills" className="py-20 px-6 bg-panel-bg/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-text/80 max-w-2xl mx-auto">Core competencies in offensive security, vulnerability research, and security architecture</p>
          </div>
      ...
      <section id="projects" className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-red-terminal mx-auto mb-6"></div>
            <p className="text-gray-text/80 max-w-2xl mx-auto">Security tools and research projects showcasing practical cybersecurity applications</p>
          </div>
      ...
      <section id="contact" className="py-20 px-6 bg-panel-bg/30">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-red-terminal mx-auto mb-6"></div>
            <p className="text-gray-text/80 max-w-2xl mx-auto">Need a security assessment or penetration test? Let's discuss how I can help secure your infrastructure.</p>
          </div>
