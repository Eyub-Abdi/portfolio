          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              <div className="mb-6 overflow-hidden">
                <p className="text-red-terminal text-sm md:text-base font-semibold uppercase tracking-widest mb-4 animate-fade-in">Aspiring Cybersecurity Professional</p>
              </div>
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-text/90 mb-8">Intermediate Ethical Hacker | Security Enthusiast</h2>

              <p className="text-lg md:text-xl text-gray-text/80 mb-12 leading-relaxed">
                I'm building my skills in cybersecurity, actively learning penetration testing, and exploring vulnerabilities. 
                Currently advancing my knowledge through hands-on labs and ethical hacking challenges.
              </p>
              ...
              <div className="pt-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-3">
                    ...
                    <span>Studying Cybersecurity</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <i className="fa-solid fa-certificate text-red-terminal"></i>
                    <span>Working towards CEH certification</span>
                  </li>
                  <li className="flex items-center gap-3">
