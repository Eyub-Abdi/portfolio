        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-text/90 leading-relaxed">I've showcased my skills in challenges like UrchinSec CTF, where I ranked in the top 4, and contributed to initiatives like Innovation Week Tanzania 2025 – Zanzibar Roadshow.</p>
