              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 z-40">
                    {/* GitHub */}
                    <a
                      href="https://github.com/Eyub-Abdi"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-1"
                    ...
                    {/* LinkedIn */}
                    <a
                      href="https://www.linkedin.com/in/eyub-abdi"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-2"
                    ...
                    {/* YouTube */}
                    <a
                      href="https://www.youtube.com/@Red.Terminal"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-12 h-12 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-3"
                    ...
                    <a
                      ...
                      className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-4"
