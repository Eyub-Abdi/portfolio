        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-text/90 leading-relaxed">I'm a passionate developer with a love for creating elegant solutions to complex problems. With expertise in both frontend and backend technologies, I bring ideas to life through code.</p>

              <p className="text-lg text-gray-text/90 leading-relaxed">My journey in tech started with curiosity and has evolved into a career focused on building impactful applications that make a difference.</p>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-red-terminal/20 to-transparent rounded-2xl p-8 border border-red-terminal/30">
                <div className="w-full h-full bg-panel-bg rounded-xl flex items-center justify-center text-8xl">👨‍💻</div>
              </div>
      ...
      <section id="skills" className="py-20 px-6 bg-panel-bg/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-text/80 max-w-2xl mx-auto">Technologies and tools I use to bring projects to life</p>
          </div>
      ...
      <section id="contact" className="py-20 px-6 bg-panel-bg/30">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-red-terminal mx-auto mb-6"></div>
            <p className="text-gray-text/80 max-w-2xl mx-auto">Have a project in mind? Let's work together to create something amazing.</p>
          </div>
