        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-text/80 mb-12 leading-relaxed">I'm building my skills in cybersecurity, actively learning penetration testing, and exploring vulnerabilities. Currently advancing my knowledge through hands-on labs and ethical hacking challenges.</p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-text/90 leading-relaxed">My journey started with curiosity about how systems work and how they can be exploited. Now I'm dedicated to building practical skills in vulnerability assessment, network security, and ethical hacking methodologies.</p>
              ...
              <div className="pt-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>Working towards eJPT certification</span>
                  </li>
                  <li className="flex items-center gap-3">
