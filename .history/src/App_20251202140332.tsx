              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <img 
                    ...
                    className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-panel-bg shadow-2xl relative z-10 cursor-pointer transition-all duration-300 hover:scale-105 hover:border-red-terminal"
                    onMouseMove={(e) => {
