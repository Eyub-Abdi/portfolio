...
function App() {
  ...
  const skills = [
    { name: 'React & TypeScript', icon: '⚛️', description: 'Building modern web applications' },
    { name: 'Node.js & Express', icon: '🟢', description: 'Backend development & APIs' },
    { name: 'Tailwind CSS', icon: '🎨', description: 'Modern UI/UX design' },
    { name: 'MongoDB & SQL', icon: '🗄️', description: 'Database management' },
    { name: 'Git & DevOps', icon: '🚀', description: 'Version control & deployment' },
    { name: 'Python & AI', icon: '🤖', description: 'Machine learning & automation' },
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ['TypeScript', 'Express', 'Socket.io', 'PostgreSQL'],
      link: '#',
    },
    {
    ...
    <div className="min-h-screen bg-dark-bg text-gray-text">
      ...
      <header 
        className={`fixed w-full z-50 transition-all duration-300 ${
          isScrolled 
            ? 'bg-black/80 backdrop-blur-md border-b border-red-terminal/10' 
            : 'bg-transparent'
        }`}
      >
              ...
              {['home', 'about', 'skills', 'projects', 'contact'].map((item) => (
                <li key={item}>
                  <a
                    ...
                    className={`capitalize text-sm font-medium transition-colors hover:text-red-terminal ${
                      activeSection === item ? 'text-red-terminal' : 'text-gray-text'
                    }`}
                  >
                    {item}
                  </a>
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          <div className="mb-6 overflow-hidden">
            <p className="text-red-terminal text-sm md:text-base font-semibold uppercase tracking-widest mb-4 animate-fade-in">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-gray-text/90 mb-8">
            Full Stack Developer & Designer
          </h2>
          
          <p className="text-lg md:text-xl text-gray-text/80 max-w-2xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-red-terminal/20 to-transparent rounded-2xl p-8 border border-red-terminal/30">
                <div className="w-full h-full bg-panel-bg rounded-xl flex items-center justify-center text-8xl">
                  👨‍💻
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <div
                key={index}
                className="group bg-panel-bg border-l-4 border-red-terminal p-6 rounded-lg hover:transform hover:-translate-y-2 transition-all duration-300 hover:shadow-xl hover:shadow-red-terminal/20"
              >
                <div className="text-4xl mb-4">{skill.icon}</div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-red-terminal transition-colors">
                  {skill.name}
                </h3>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group bg-panel-bg rounded-xl overflow-hidden border border-gray-text/10 hover:border-red-terminal/50 transition-all duration-300 hover:transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-terminal/20"
              >
                <div className="aspect-video bg-gradient-to-br from-red-terminal/20 to-panel-bg flex items-center justify-center text-6xl group-hover:scale-105 transition-transform duration-300">
                  💻
                </div>
                
                <div className="p-6">
                  <h3 className="text-2xl font-semibold text-white mb-3 group-hover:text-red-terminal transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech, i) => (
                      <span 
                        key={i}
                        className="px-3 py-1 bg-red-terminal/10 text-red-terminal text-sm rounded-full border border-red-terminal/30"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <a
                    href={project.link}
                    className="inline-flex items-center gap-2 text-red-terminal font-semibold hover:gap-3 transition-all"
                  >
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-panel-bg p-8 rounded-xl border border-red-terminal/20">
              ...
              <a href="mailto:your.email@example.com" className="text-red-terminal hover:underline">
          ...
          <form className="bg-panel-bg p-8 rounded-xl border border-red-terminal/20">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <input
                ...
                className="w-full px-4 py-3 bg-dark-bg border border-gray-text/20 rounded-lg text-white placeholder-gray-text/50 focus:border-red-terminal focus:outline-none transition-colors"
              />
              <input
                type="email"
            ...
            <input
              type="text"
              placeholder="Subject"
              className="w-full px-4 py-3 bg-dark-bg border border-gray-text/20 rounded-lg text-white placeholder-gray-text/50 focus:border-red-terminal focus:outline-none transition-colors mb-6"
            />
            
            <textarea
              rows={6}
              placeholder="Your Message"
              className="w-full px-4 py-3 bg-dark-bg border border-gray-text/20 rounded-lg text-white placeholder-gray-text/50 focus:border-red-terminal focus:outline-none transition-colors mb-6 resize-none"
            ></textarea>
            
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-red-terminal to-red-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:scale-105 transition-transform shadow-lg shadow-red-terminal/30"
            >
              Send Message
            </button>
          </form>
      ...
      <footer className="bg-black/50 border-t border-red-terminal/10 py-8 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-text/70 text-sm">
