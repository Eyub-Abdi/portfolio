              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -inset-16 z-40">
                    {/* GitHub - Top */}
                    <a href="https://github.com/Eyub-Abdi" target="_blank" rel="noopener noreferrer" className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-1">
                      <i className="fab fa-github text-xl"></i>
                    </a>

                    {/* LinkedIn - Right */}
                    <a href="https://www.linkedin.com/in/eyub-abdi" target="_blank" rel="noopener noreferrer" className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-2">
                      <i className="fab fa-linkedin text-xl"></i>
                    </a>

                    {/* YouTube - Bottom */}
                    <a href="https://www.youtube.com/@Red.Terminal" target="_blank" rel="noopener noreferrer" className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-14 h-14 bg-panel-bg border-2 border-red-terminal rounded-full flex items-center justify-center text-red-terminal hover:bg-red-terminal hover:text-white transition-all duration-300 hover:scale-110 animate-orbit-3">
