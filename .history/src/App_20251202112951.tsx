    ...
    <div className="min-h-screen bg-dark-bg text-gray-text">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-gray-text/90 mb-8">Ethical Hacker & Penetration Tester</h2>

          <p className="text-lg md:text-xl text-gray-text/80 max-w-2xl mx-auto mb-12 leading-relaxed">I secure digital infrastructures, hunt for vulnerabilities, and protect systems from cyber threats. Let's make the digital world safer together.</p>
