            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  {/* Main Image */}
                  <img src="/anon.jiff" alt="Ayub Abdi - Cybersecurity Specialist" className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-panel-bg shadow-2xl relative z-10" />
