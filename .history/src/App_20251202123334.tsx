        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-text/90 leading-relaxed">I've showcased my skills in challenges like <a href="https://www.linkedin.com/company/urchinsec/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-red-terminal hover:underline">UrchinSec</a> CTF, where I ranked in the top 4.</p>
