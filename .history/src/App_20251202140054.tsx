            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  {/* Mouse Follow Effect */}
                  <div className="absolute inset-0 rounded-full overflow-hidden z-15 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div 
                      className="absolute w-40 h-40 bg-red-terminal/40 rounded-full blur-3xl transition-all duration-200"
                      style={{
