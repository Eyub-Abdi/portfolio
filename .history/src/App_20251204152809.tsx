        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-text/90 leading-relaxed">I'm an I'm an aspiring penetration tester actively developing my skills in ethical hacking, network security, and vulnerability analysis. I learn through structured labs, online platforms, and security communities.</p>
